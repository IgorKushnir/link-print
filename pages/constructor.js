  ...
  return (
    <>
      ...
      {isPopupOpened && <ContactModal setIsPopupOpened={setIsPopupOpened}/>}
          ...
          <div className="container">
            ...
            <div className={styles.headingWrap}>
              <div className={styles.leftPart}>
                <p className={styles.spec}>ПОСТРОЙТЕ ВМЕСТЕ С НАМИ ПРИНТЕР, КОТОРЫЙ РЕШАЕТ ИМЕННО ВАШИ ЗАДАЧИ</p>
              </div>
              <div className={styles.rightPart}>
                <p>С помощью данного конструктора вы можете самостоятельно собрать принтер который подходит под ваши производственные потребности</p>
              </div>
            </div>
        ...
        {constructor?.printType && <div className={styles.infoBlock}>
        ...
        {constructor?.materialType && <div className={styles.infoBlock}>
          <h4 className={styles.constructSubheading}>Тип подачи материала</h4>
        ...
        <div className={styles.infoBlock}>
          ...
          <label htmlFor="maxGabarity" className={styles.textLabel}>Максимальные габариты изделия</label>
            <input
              type="text"
              name="maxGabarity"
              required
              ...
              onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.maxGabarity}
            />
          ...
          <div className={styles.inputWrapper}>
          <label htmlFor="material" className={styles.textLabel}>Материал для печати</label>
            <input
              type="text"
              name="material"
              required
              ...
              className={styles.textInput}
              onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.material}
            />
        ...
        <div className={styles.infoBlock}>
          ...
          <div className={styles.rangeMainInfoWrapper}>
                  <p className={styles.rangeStart}>{formik.values.printSpeed}</p>
                </div>
            <input
              type="range"
              name="printSpeed"
            ...
            />
              <div className={styles.rangeInfoWrapper}>
                ...
                <p className={styles.rangeEnd}>{constructor?.printSpeedMax}</p>  
                </div>
          </div>
        </div>
        ...
        <div className={styles.infoBlock}>
          <h4 className={styles.constructSubheading}>Типы используемых чернил</h4>
        ...
        <div className={styles.infoBlock}>
        <div className={styles.inputWrapper}>
          <label htmlFor="comments" className={styles.textLabel}>Комментарии</label>
            <input
              type="text"
              name="comments"
              required
