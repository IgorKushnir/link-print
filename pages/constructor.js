...
export default function ResearchPage() {
  ...
  return (
    <>
      <Head>
        <title>Конструктор принтера Link Print</title>
        <link rel="icon" href="/favicon.ico" />
        <meta
          name="description"
          content="Создайте свой принтер и мы изготовим его для Вас. Link Print"
        />
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="Конструктор принтера Link Print" />
        <meta
