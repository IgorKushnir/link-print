...
export default function ClassesPage() {
    ...
    return (
        <>
          <Head>
            <title>Типы принтеров Link Print</title>
            <link rel="icon" href="/favicon.ico" />
            <meta name="description" content="Описание типов принтеров компании LinkPrint" />
            ...
            <meta property="og:title" content="Типы принтеров Link Print" />
            <meta property="og:description" content="Описание типов принтеров компании LinkPrint" />
